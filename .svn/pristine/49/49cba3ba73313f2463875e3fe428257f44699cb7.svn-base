$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL+'/eir/eirLess/wait', colunms);
    table.setExpandColumn(2);
    table.setIdField("id");
    table.setCodeField("id");
    table.setParentCodeField("id");
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '预约号', field: 'id', visible: false, align: 'center', valign: 'middle', width: '80px'},
        {title: '司机', field: 'userName', align: 'center', valign: 'middle', sortable: true, width: '100px'},
        {title: '手机号码', field: 'phone', align: 'center', valign: 'middle', sortable: true, width: '100px'},
        {title: '车牌号码', field: 'plate', align: 'center', valign: 'middle', sortable: true, width: '80px',},
        {title: '作业类型', field: 'tranType', align: 'center', valign: 'middle', sortable: true, width: '60px',},
        {title: '作业数量', field: 'tranCount', align: 'center', valign: 'middle', sortable: true, width: '60px',},
        ...
        {title: '预约时间', field: 'appointmentTime', align: 'center', valign: 'middle', sortable: true,width: '100px'},
        {
...
var vm = new Vue({
    ...
    methods: {
        ...
        pass: function () {
            ...
            if(this.selectMsg==''){
                this.selectMsg="您的内贸飞单已审核通过，请按预约时间进闸签到，以激活作业。签到前请先完成验箱及可能的费用处理.";
            }
