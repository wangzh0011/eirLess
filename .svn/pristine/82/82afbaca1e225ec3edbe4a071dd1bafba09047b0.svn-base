$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL+'/eir/eirLess/list_reconfirm', colunms);
   // table.setExpandColumn(2);
    table.setIdField("id");
    table.setCodeField("id");
    table.setParentCodeField("id");
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '预约号', field: 'id',     sortable: false, align: 'center', valign: 'middle', width: '80px'},
        {title: '司机', field: 'userName', align: 'center', valign: 'middle', sortable: false, width: '100px'},
        {title: '手机号码', field: 'phone', align: 'center', valign: 'middle', sortable: false, width: '100px'},
        {title: '车牌号码', field: 'plate', align: 'center', valign: 'middle', sortable: false, width: '80px',},
        ...
        {title: '状态', field: 'state', align: 'center', valign: 'middle', sortable: false, width: '60px',formatter(item,index){
                   //'<span class="label label-danger">禁用</span>'
                   return '<span class="label label-success">'+item.state+'</span>';

            }},

        {title: '备注', field: 'remark', align: 'center', valign: 'middle', sortable: false,width: '100px'},
        {title: '预约时间', field: 'appointmentTime', align: 'center', valign: 'middle', sortable: false,width: '100px'},
        {title: '操作', field: 'appointmentTime', align: 'center', valign: 'middle', width: '100px',sortable: false, formatter: function (item, index) {
                var id = item.id;
        ...
        {title: '更新时间', field: 'updateTime', align: 'center', valign: 'middle', sortable: false,width: '100px'},
...
var vm = new Vue({
    ...
    data: {
        ...
        selectMsg:'您的内贸飞单已审核通过，请按预约时间进闸签到，以激活作业。签到前请先完成验箱及可能的费用处理.',
        rawHtml: "",
        a: {
            ad: "ad",
        },
    ...
    methods: {
        ...
        getEirLessAll: function () {
            $.get(baseURL + "eir/eirLess/list", function (res) {
                console.log(res)
                vm.eirLess = res;
